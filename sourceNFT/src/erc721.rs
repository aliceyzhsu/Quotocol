...
impl<T: Erc721Params> Erc721<T> {
    ...
    // pub fn most_quoted(&self, mut n: U256) -> Result<[U256; 20], Erc721Error> {
    //     n = n.max(U256::from(20));
    //     let mut tokens: Vec<(U256, U256)> = vec![];
    //     for i in 0..self.total_supply.get() as u64 {
